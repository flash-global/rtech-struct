...
describe('Dimension structure', () => {
  ...
  test('Success: package v1 structure', () => {
    expect(s.is(['1', '100', '120', '120', '5', 'no'], packageV1)).toBeTruthy()
  })

  test('Failed: package v1 structure', () => {
    expect(s.is(['1', 'no'], packageV1)).toBeFalsy()
  })

  test('Success: package v2 structure', () => {
    expect(
      s.is(['1', '100', '120', '120', '5', 'no', 'TOXIC LIQUID', '100', 'Premium Insurance'], packageV2)
    ).toBeTruthy()
  })

  test('Failed: package v2 structure', () => {
    expect(s.is(['1', '100', '120', '120', '5', 'no'], packageV2)).toBeFalsy()
  })
})
